        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Kabar Burung<small>Edit<br/>(Terakhir diubah: 
                  <?= $kabarburung->return ? humantime($kabarburung->data->terakhir_diubah->real_datetime) : "SERVER ERROR"; ?>)</small></h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <?php if ( ! $kabarburung->return): ?>
